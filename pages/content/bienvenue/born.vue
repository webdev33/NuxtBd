  ...
  <section class="comic">
    ...
    <div class="comicBox comicBox--nee">
      ...
      <div class="comic__text animation--text">
        ...
        >Fulgence Bienvenüe est né le 27 janvier 1852 à Uzel (Côtes-d’Armor) en Bretagne.</p>
      </div>
      <img
    ...
    <div class="videoBox__wrapper videoBox__wrapper--1 slideIn--later">
      <div class="videoBox">
        ...
        <div class="videoBox__audiodescriptionBox">
          ...
          >Ils fallait qu’ils amènent leurs pelles et leurs pioches et c’était donc par trains entiers qu’ils venaient comme ça à Paris. Et d’ailleurs on peut dire que le métro parisien à été construit en bonne partie par les bretons, ils ont été très nombreux dans ce chantier.</p>
        </div>
      </div>
    </div>
  ...
  mounted: function mounted() {
    ...
    let videoPlus = function() {
      ...
      buttonVideo.addEventListener("click", function() {
        ...
        document
          .querySelector(".icon--untertitel--" + videoNumber)
          .addEventListener("click", function() {
            document
              .querySelector(".videoBox__audiodescription--" + videoNumber)
              .classList.toggle("slideIn--now");
          });
    ...
    buttonNext.addEventListener("click", function() {
        ...
        switch (buttonNextCounter) {
          ...
          case 2:
            textBoxContent.innerHTML =
              "Il etait installe sur le cintiere de Pere La Chaise. ";
      ...
      if (commicBox.classList.contains("comicBox--nee")) {
        ...
        switch (buttonNextCounter) {
          case 1:
            textBoxContent.innerHTML =
              "Il est le treizième enfant d’une famille bretonne d’origine normande. <span class='link--video' videoLinkId='1' >d’origine normande</span>";
            videoPlus();
          ...
          case 2:
            textBoxContent.innerHTML =
              "La ligne de chemin de fer Paris - Brest est achevée à la fin du XIXème siècle, comme des milliers de bretons, Bienvenüe en profite pour tenter sa chance à la capitale. <span class='link--video' videoLinkId='2' >d’origine normande</span>";
            videoPlus();
      ...
      if (commicBox.classList.contains("comicBox--triumph")) {
        ...
        switch (buttonNextCounter) {
          case 1:
            textBoxContent.innerHTML =
              "Il reçoit la grande médaille d’or de la ville de Paris en 1924.";
          ...
          case 2:
            textBoxContent.innerHTML =
              "Il devient Grand-Croix de la Légion d’Honneur en 1929 par le décret du 26 janvier 1929.<br> Cette distinction lui est décernée en récompense des services rendus auprès de la ville de Paris.";
      ...
      if (commicBox.classList.contains("comicBox--trauma")) {
        ...
        switch (buttonNextCounter) {
          case 1:
            textBoxContent.innerHTML =
              "La catastrophe du métropolitain, le 10 août 1903 dans les stations Couronnes et Ménilmontant..";
      ...
      if (commicBox.classList.contains("comicBox--carrier")) {
        ...
        switch (buttonNextCounter) {
          case 1:
            textBoxContent.innerHTML =
              "C’est lors de l’Exposition Universelle de 1900 que fut mis en service la première ligne du Métropolitain : Porte de Vincennes - Porte Maillot.";
