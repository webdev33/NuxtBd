<template>
  <section class="comic">
    ...
    <div class="discoverBox">
      ...
      <a href="article.html" class="button button--discover">Decouvrir la ligne</a>
    </div>
    ...
    <div class="comicBox comicBox--carrier">
      ...
      <div class="comic__text animation--text">
        ...
        >Le 20 avril 1896, le Conseil municipal de Paris adopte le projet de réseau de Fulgence Bienvenüe.</p>
      </div>
      <img
